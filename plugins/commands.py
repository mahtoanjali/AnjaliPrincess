...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            InlineKeyboardButton('Watch Tutorial', url='https://t.me/QUEENx_GOD')
            ],
            [
        ...
        await asyncio.sleep(2) # 😢 https://github.com/mahtoanjali/AnjaliPrincess/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🦋 Channel 🦋", url='https://t.me/QUEENx_GOD'
                )
            ]
        ]
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You QUEENx_GOD ♥️')
